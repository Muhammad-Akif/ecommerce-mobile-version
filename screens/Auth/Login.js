            ...
            <View style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={{ justifyContent: 'flex-start' }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', top: -10, marginTop: 60 }}>
                        <Card style={{ width: '44.4%' }} text={'Continue as User'} image={require('../../assets/images/user.png')} />
                        <Card style={{ width: '44.4%' }} text={'Continue as Admin'} image={require('../../assets/images/admin.png')} />
                    </View>
